...
export const trendingMultiMediaController = async (req, res) => {
  try {
    ...
    const data = await fetchData(
      trendingMultiMedia + page + "&api_key=b11b4b329904a8f670342a8ece566183"
    );
...
export const discoverMovieController = async (req, res) => {
  try {
    ...
    const data = await fetchData(
      discoverMovieMedia + page + "&api_key=b11b4b329904a8f670342a8ece566183"
    );
...
export const discoverTvController = async (req, res) => {
  try {
    ...
    const data = await fetchData(
      discoverTvMedia + page + "&api_key=b11b4b329904a8f670342a8ece566183"
    );
